...
--
-- Host: localhost:3306
-- Generation Time: Jan 03, 2023 at 09:12 PM
...
(76, NULL, 22, 2, '9780684833392', 'Catch-22', '22.00', 2004, 12, 'The novel is set during World War II, from 1942 to 1944. It mainly follows the life of Captain John Yossarian, a U.S. Army Air Forces B-25 bombardier. Most of the events in the book occur while the fictional 256th Squadron is based on the island of Pianosa, in the Mediterranean Sea, west of Italy. The novel looks into the experiences of Yossarian and the other airmen in the camp, who attempt to maintain their sanity while fulfilling their service requirements so that they may return home.', '76.jpg', 21, 1, 0),
...
(97, NULL, 79, 2, '9780393341768', 'A Clockwork Orange', '10.05', 2019, 7, 'In Anthony Burgesss influential nightmare vision of the future, criminals take over after dark. Teen gang leader Alex narrates in fantastically inventive slang that echoes the violent intensity of youth rebelling against society. Dazzling and transgressive, A Clockwork Orange is a frightening fable about good and evil and the meaning of human freedom. This edition includes the controversial last chapter not published in the first edition, and Burgessâ€™s introduction, â€œA Clockwork Orange Resucked.â€', '97.jpg', 19, 1, 0),
...
(78, 'W. W. Norton &amp;amp; Company'),
(79, 'W. W. Norton &amp;amp;amp; Company'),
(11, 'Warner Books'),
...
(15, 'Jan', 'Doe', 'jandoe@gmail.com', '3049a1f8327e0215ea924b9e4e04cd4b0ff1800c74a536d9b81d3d8ced9994d3', 'Santo Tomas', 'Calabarzon', 'Philippines', 1, 0, 0, '2022-12-31');
...
--
ALTER TABLE `book_authors`
  MODIFY `book_author_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239;
--
-- AUTO_INCREMENT for table `book_genres`
--
ALTER TABLE `book_genres`
  MODIFY `book_genres_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1284;
--
...
--
ALTER TABLE `publishers`
  MODIFY `publisher_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
--
