<?php
    ...
    if(isset($_POST["RecordRecommendationClick"])){
        ...
        if($_POST["isRecommended"] == false){
            ...
            $sql = "insert into events (user_ID,book_ID,event_type_ID,datetime_occurred,is_deleted) values ('".$_POST["user_ID"]."','".$_POST["book_ID"]."','2','".date("Y-m-d H:i:s")."','0')";
        }
        $last_id = -1;
